...
sink("./analysis/geomorph-rates/rates-family-astragalus.txt")
print(summary(rates_fam_astrag))
sink()
...
# write results summary to txt file
sink("./analysis/geomorph-rates/rates-infraorder-astragalus.txt")
print(summary(rates_infra_astrag))
sink()
...
# write results summary to txt file
sink("./analysis/geomorph-rates/rates-parvorder-astragalus.txt")
print(summary(rates_parv_astrag))
sink()
...
disp_fam_astrag <- 
  morphol.disparity(
    ...
    shape_data_means_astrag ~ 1,
    # specify groups you want to compare
    groups = species_data$Family
  )

# write results summary to txt file
sink("./analysis/disparity/disparity-family-astragalus.txt")
print(summary(disp_fam_astrag))
sink()
...
# write results summary to txt file
sink("./analysis/disparity/disparity-infraorder-astragalus.txt")
print(summary(disp_infra_astrag))
sink()
...
# write results summary to txt file
sink("./analysis/disparity/disparity-parvorder-astragalus.txt")
print(summary(disp_parv_astrag))
sink()
