...
sink("./analysis/geomorph-rates/rates-family-navicular.txt")
print(summary(rates_fam_navic))
sink()
...
# write results summary to txt file
sink("./analysis/geomorph-rates/rates-infraorder-navicular.txt")
print(summary(rates_infra_navic))
sink()
...
# write results summary to txt file
sink("./analysis/geomorph-rates/rates-parvorder-navicular.txt")
print(summary(rates_parv_navic))
sink()
...
disp_fam_navic <- 
  morphol.disparity(
    ...
    shape_data_means_navic ~ 1,
    # specify groups you want to compare
    groups = species_data$Family
  )

# write results summary to txt file
sink("./analysis/disparity/disparity-family-navicular.txt")
print(summary(disp_fam_navic))
sink()
...
# write results summary to txt file
sink("./analysis/disparity/disparity-infraorder-navicular.txt")
print(summary(disp_infra_navic))
sink()
...
# write results summary to txt file
sink("./analysis/disparity/disparity-parvorder-navicular.txt")
print(summary(disp_parv_navic))
sink()
